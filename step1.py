...
def ppssm(inp,protein):
    os.system("psiblast -query "+inp+" -db /home/miranda/ATD2.0/blast/db/swissprot/swissprot -num_iterations 4 -out ./"+protein+"_"+chain+".txt -out_ascii_pssm ./"+protein+"_"+chain+".pssm")
...
def ddata(inp,protein,fpath,chain):
    path3="./step1-calcon-"+protein+"_"+chain+"/con-"+protein+"_"+chain+".xls"
    list0=[]
    list1=[]
    list3=[]
