...
def all_index():
    ...
    22. Sus scrofa --> pig                         23. Chlorocebus-sabaeus --> green monkey'''))
...
if __name__ == '__main__':
    all_args=all_index()
    if all_args.way=='msa':
        os.system('python3 ./AutoDVD2/step1.py -c '+all_args.chain+' -if '+all_args.in_fasta_file+' -p '+all_args.pdb_name+' -m '+all_args.msa_file+' -w '+all_args.way)
    else:
        os.system('python3 ./AutoDVD2/step1.py -c '+all_args.chain+' -if '+all_args.in_fasta_file+' -p '+all_args.pdb_name+' -w '+all_args.way)
    os.system('python3 ./AutoDVD2/step2.py -c '+all_args.chain+' -if '+all_args.in_fasta_file+' -ip '+all_args.in_PDB_file+' -p '+all_args.pdb_name+' -w '+all_args.way)
