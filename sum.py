...
def all_index():
    ...
    for example: "./ATD2.0/demo/5X5C.fasta+./ATD2.0/demo/5K6G.fasta”. Note that the writing order of the paths should correspond to the PDB number or the name of the pathogen protein.'''))
    ...
    for example: "./ATD2.0/demo/5X5C.pdb+./ATD2.0/demo/5K6G.pdb”. 
    ...
    parser.add_argument('-ho', '--host', type=str, required=True,
                        help=textwrap.dedent('''\
    The "./ATD2.0/codon" folder stores the codon usage tables of 22 common species. Users only need to enter the Latin scientific name of the host to be vaccinated. 
